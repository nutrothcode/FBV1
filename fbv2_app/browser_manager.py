...
class BrowserManager:
    ...
    def open_firefox_instance(self, instance_number: int, login: bool = True, clear_data_action: bool = False) -> None:
    ...
    def get_id(self, instance_number: int) -> str | None:
        ...
        try:
            ...
            logging.debug("Get ID navigation warning for Firefox %s: %s", instance_number, exc)
        ...
        try:
            ...
            logging.error("Get ID failed for Firefox %s: %s", instance_number, exc)

        logging.warning("Get ID did not find a numeric account id for Firefox %s.", instance_number)
        return None
